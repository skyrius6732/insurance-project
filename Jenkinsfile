        ...
        stage('Deploy') {
            steps {
                script {
                    ...
                    // 예: insurance-project-insurance-app-8081, insurance-project-insurance-app-8082
                    newContainerName = "insurance-project-insurance-app-${newDeploymentPort}"
                    oldContainerName = "insurance-project-insurance-app-${oldDeploymentPort}"
                    ...
                    sh "docker run -d --name insurance-project-insurance-app-${newDeploymentPort} --network insurance-project_insurance-network -p ${newDeploymentPort}:8080 -e SPRING_KAFKA_BOOTSTRAP_SERVERS=kafka:19092 skyrius6732/insurance-project:latest"
